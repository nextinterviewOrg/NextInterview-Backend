...
const userChallengesSchema = new mongoose.Schema({
    ...
    question_type: {
        ...
        message: 'question type must be one of the defined types'
    },
    isDeleted: { type: Boolean, default: false },
    base_code: { type: String, required: false },
    option_a: { type: String, required: false },
    option_b: { type: String, required: false },
    ...
    dbSetupCommands: { type: String, required: false },
    solutionCode: { type: String, required: false },
    solutionExplanation: { type: String, required: false }
}, { timestamps: true });
